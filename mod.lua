			...
			params = {
				{
					...
					values = { _("param_val_default_tram"), _("param_val_historical_tram") },
					defaultIndex = 1,
				},
				{
					...
					values = { _("param_val_default_track"), _("param_val_historical_track") },
					defaultIndex = 1,
				},
				{
					...
					values = { _("param_val_default_bus"), _("param_val_historical_bus") },
					defaultIndex = 1,
				},
				{
					key = "vehicle_set",
